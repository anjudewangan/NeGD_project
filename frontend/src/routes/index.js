...
const Ecommerce = lazy(() => import('components/dashboards/e-commerce'));
const Lms = lazy(() => import('components/dashboards/lms'));
import ProjectManagement from 'components/dashboards/project-management';
import Migration from 'components/documentation/Migration';
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: `${paths.contactDetails}/:ticketId`,
                element: <ContactDetails />
              },
              {
                path: `${paths.ticketsPreview}/:ticketId`,
