...
export const notifications = [
  ...
  },
  {
    ...
    children:
      "<strong>Ajay Varma</strong> invited to join the group: United Nations International Children's Fund",
    time: '2d',
    emoji: '🙋‍',
    className: 'rounded-0 border-x-0 border-300 border-bottom-0',
    to: '#!'
...
export const rawNewNotifications = [
  {
    ...
    children:
      '<strong>Priyanka Sahu</strong> replied to your comment : "Hello world 😍"',
    time: 'Just Now',
    emoji: '💬',
    className: 'rounded-0 border-x-0 border-300 border-bottom-0',
    to: '#!',
...

  {
    ...
    children:
      "<strong>Govind Singh</strong> reacted to <strong>Mia Khalifa's</strong> status",
    time: '9hr',
    emoji: '❤️',
    className: 'rounded-0 border-x-0 border-300 border-bottom-0',
    to: '#!',
