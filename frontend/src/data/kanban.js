...
export const kanbanItems = [
  ...
  },
  {
    ...
    items: [
      {
        id: 60000001,
        title: 'User unable to reset password from login page',
        user: 'John',
        labels: [
          { type: 'danger', text: 'Urgent' },
          { type: 'warning', text: 'Bug' }
        ],
        checklist: { totalCount: 2, completed: 1 },
        attachments: [
          { type: 'txt', url: 'error-log.txt' }
        ],
        members: [
          { name: 'John', url: team2 },
          { name: 'Emma', url: team3 }
      ...
      {
        id: 60000002,
        title: 'Live chat not loading on mobile devices',
        user: 'Anna',
        labels: [
          { type: 'danger', text: 'Mobile' },
          { type: 'info', text: 'UI' }
        ],
        members: [
          { name: 'Anna', url: team1 },
      ...
      {
        id: 60000003,
        title: 'Billing discrepancy in annual invoice for customer X',
        user: 'Antony',
        labels: [
          { type: 'warning', text: 'Finance' },
          { type: 'secondary', text: 'Customer Issue' }
        ],
        checklist: { totalCount: 3, completed: 2 },
        attachments: [
          { type: 'pdf', url: 'invoice-customer-x.pdf' }
        ],
        members: [
          { name: 'Antony', url: team2 },
          { name: 'Sophie', url: team4 }
      ...
      {
        id: 60000004,
        title: 'App crashes on login when offline mode is enabled',
        user: 'Sophie',
        labels: [
          { type: 'danger', text: 'Crash' },
          { type: 'primary', text: 'Offline' }
        ],
        checklist: { totalCount: 4, completed: 0 },
        members: [
          { name: 'Sophie', url: team3 }
        ],
        attachments: [
          { type: 'doc', name: 'crash-report.docx' }
        ]
      }
    ]
  }
