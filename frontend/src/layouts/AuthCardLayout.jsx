            ...
            <Card.Body className="p-0">
              <Row className="h-100 g-0">
                <Col md={5} className="text-white text-center bg-card-gradient">
                  <div className="position-relative p-4 pt-md-5 pb-md-4">
                    <Background
                      image={halfCircle}
                    ...
                    >
                      ...
                      <p className="opacity-75 text-white">
                        National e-Governance Division was created by the Ministry of Electronics & Information Technology as an Independent Business Division under the Digital India Corporation a section 8 not-for-profit company.
                      </p>
                    </div>
                  </div>
                  <div
                    ...
                    {footer && (
                      <p className="mb-0 mt-4 mt-md-5 fs-10 fw-semibold text-white opacity-75">
                        ...
                        <Link
                          ...
                          to="https://patiodigital.com/" target='_blank'
                        >
                          Patio Digital{' '}
                        </Link>
                      </p>
