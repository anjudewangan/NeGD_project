...
const ContactProfile = () => {
  ...
  const dialOutbound = async () => {
    const response = await axiosInstance.post(
      "/telephony/dial-ticket-id",
      { ticketId: ticketId },
      ...
      <Card.Body className="bg-body-tertiary">
        ...
        <Row className="border rounded-3 p-x1 mt-3 bg-white dark__bg-1000 mx-0 g-0">
          <Col md={6} xl={12} className="pe-md-4 pe-xl-0">
            <InfoItem title="Email" content="ramkumart123@gmail.com" />
            <InfoItem title="Phone Number" content="+91 9988550123" />
            <InfoItem
              title="Location"
              content="H No. 01, MH Colony, Mumbai, Maharashtra"
            />
          ...
          <Col md={6} xl={12} className="ps-md-4 ps-xl-0">
            <InfoItem title="Aadhar Status" content="Verified" />
            <InfoItem title="Platform" content="Android" />
            <InfoItem title="OS" content="Android 13" />
            <InfoItem title="App Version" content="3.1.2" />
            <InfoItem title="Mobile Handset" content="Samsung Galaxy M32" />
            <h6>Issue Type</h6>
            <Link
              to="#!"
