  ...
  return (
    <Card className="h-md-100">
      <Card.Header className="pb-0">
        <h6 className="mb-0">Avg. Call Response Time (within 10 sec)</h6>
      </Card.Header>
        ...
        <Row className="align-items-end h-100 mb-n1 mt-n3">
          <Col xs={5} className="pe-0 pe-lg-3">
            <Row className="g-0">
              ...
              <Col xs={5}>
                <h6 className="text-800">95% </h6>
              </Col>
            </Row>
            <Row className="g-0">
              <Col xs={7}>
                <h6 className="text-600">Current: </h6>
              </Col>
              <Col xs={5}>
                <h6 className="text-800">89% </h6>
              </Col>
            </Row>
            <Row className="g-0">
              <Col xs={7}>
                <h6 className="mb-0 text-600">Penalty: </h6>
              </Col>
              <Col xs={5}>
                <h6 className="mb-0 text-800">6% </h6>
              </Col>
            </Row>
          </Col>
          <Col xs={7}>
