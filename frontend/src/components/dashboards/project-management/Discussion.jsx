      ...
      <Card.Header className="pb-0">
        <Flex justifyContent="between">
          <div>
            ...
            <h5 className="text-primary fs-9">Team discussion</h5>
          </div>
          <div
          ...
          >
            <h5 className="text-primary mb-0 d-flex flex-column mt-n1">
              <span>10</span>
              <small className="text-primary fs-11 lh-1">June</small>
            </h5>
          </div>
        </Flex>
      </Card.Header>
        ...
        <Row className="g-3 justify-content-between">
          <Col xs={10} className="mt-0">
            <p className="fs-10 text-600 mb-0">
              The very first general meeting for planning user tickets
            </p>
          </Col>
