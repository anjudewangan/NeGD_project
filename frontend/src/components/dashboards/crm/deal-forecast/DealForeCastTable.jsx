      ...
      <Table className="fs-10 mb-0">
        <thead className="bg-200">
          <tr>
            ...
            <th className="text-800 text-nowrap text-center">Inbound Calls</th>
            <th className="text-800 text-nowrap text-center">Outbound Calls</th>
            <th className="text-800 text-nowrap text-end">Queue Analysis</th>
          </tr>
        </thead>
        <tbody>
          {data.map((item, index) => (
